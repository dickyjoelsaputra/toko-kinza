            ...
            <div class="d-flex align-items-stretch flex-wrap m-0">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Toko WOOOWO
                                Kinza</span>
                        </h4>
                        <form method="POST"
                        ...
                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Dicky Joel . Made with 💙 by Stisla
                        </div>
                    </div>
                </div>
