        ...
        <div class="card">
            ...
            <div class="mx-3">
                        ...
                        <div class="col-sm">
                            ...
                            <div class="form-group">
                                ...
                                <input id="code" name="code" type="text"
                                    placeholder="kosongkan jika tidak ada barcode" value="{{ $items->code }}"
                                    class="form-control">
                            </div>
                            <div class="form-group">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4 col-8 mb-2">
                                                <input name="[]price" type="text" class="form-control price"
                                                    placeholder="Harga" value="{{ $price->price }}">
                                            </div>
                                            <div class="col-md-3 col-4 mb-2">
                                                <input name="[]minimal" type="text" class="form-control"
                                                    placeholder="Minimal" value="{{ $price->minimal }}">
                                            </div>
                                                ...
                                                <select class="form-control select2" name="unit">
                                                    ...
                                                    @foreach ($units as $unit)
                                                        <option value="{{ $unit->id }}"
                                                            {{ $unit->id == $price->unit_id ? 'selected' : '' }}>
                            ...
                            <div class="d-flex flex-column align-items-center">
                                <button type="button" id="priceBtn" class="btn btn-primary mt-3">Tambah Harga
                                    Jual</button>
                            </div>
                            {{-- Button End --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3 text-center">
                                ...
                                <div id="photoPreview" class="photo-container">
                                    <img src="{{ asset('storage/' . $items->photo) }}" alt="Preview Foto"
                                        class="img-fluid myImage" data-name="{{ $items->photo }}">
                                </div>
                                <div class="d-flex flex-column align-items-center">
                ...
                <div class="d-flex flex-column align-items-center mb-5">
                    <button type="button" id="tambah" class="btn btn-success mt-3">Simpan Perubahan</button>
                </div>
                </form>
                {{-- END --}}
            </div>
        ...
        $(document).ready(function() {
            ...
            function playSuccessSound() {
                const successSound = new Audio(
                    "{{ asset('asset/sound/mixkit-game-notification-wave-alarm-987.wav') }}");
            ...
            $('#tambah').click(function() {
                ...
                var imageName = imageElement.data('name');
